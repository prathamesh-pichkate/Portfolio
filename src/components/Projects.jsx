...
const Projects = () => {
  ...
  <h1 class="text-4xl font-bold text-zinc-700">My Recent Projects</h1>
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-center items-center">
              ...
              <div className="flex justify-center items-center gap-2">
                <button type="button" class="text-white bg-blue-200 hover:bg-blue-300 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-2 py-2 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View More</button>
              </div>
            </div>
          </div>
        ))}
